...
class DjangoHTMLTranslator(HTMLTranslator):
    ...
    version_text = {
        'deprecated': 'Deprecated in {{ cookiecutter.project_title }} %s',
        'versionchanged': 'Changed in {{ cookiecutter.project_title }} %s',
        'versionadded': 'New in {{ cookiecutter.project_title }} %s',
    }
